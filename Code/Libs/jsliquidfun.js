...
function b2Assert(A)
{
	if (!A)
	{
		//console.log("Assertion failed! Pls debug.");//JJK
		//debugger; //JJK
	}
}
...
/// A circle shape.
function b2CircleShape(inputRadius) //JJK Added in radius as an input 
{
	this.parent.call(this);

	this.m_type = b2Shape.e_circle;
	this.m_radius = inputRadius||0;//JJK Added in inputRadius setting here
	this.m_p = new b2Vec2();
...
b2ContactFilter.prototype =
{
	...
	{
	    if (fixtureA.GetUserData().desc=="grassFront"||fixtureB.GetUserData().desc=="grassFront"){
	        var y="nope";
	    }
	    if (fixtureA.GetUserData().desc=="grassBack"||fixtureB.GetUserData().desc=="grassBack"){
            var y="nope";
        }
...
function b2World(gravity,doSleep)//TODO JJK ADDSLEEP
{
	...
	this.m_allowSleep = doSleep;//TODO JJK ADDDOSLEEP
	...
	var bd = new b2BodyDef();//TODO JJK Bodydef
    this.m_groundBody = this.CreateBody(bd);//TODO JJK Bodydef
...
b2World.prototype =
{
	...
	GetGroundBody:function() {//TODO JJK Entered in separately:
